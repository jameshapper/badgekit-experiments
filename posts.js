...
function PostsDAO(db) {
    ...
    this.getPosts = function(num, callback) {
        ...
        //here it looks like an index on 'date' would remove the need to sort if we find by date
    ...
    this.getPostsByTag = function(tag, num, callback) {
        ...
        //This may be more tricky, since tags are an array, so we need a multikey index. 'date' should still be part of a compound index, I think
    ...
    this.getPostByPermalink = function(permalink, callback) {
        ...
        //it seems a simple index by permalink would do the job here
